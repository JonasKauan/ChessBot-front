...
import { isBishopMoveValid, isKingMoveValid, isKnightMoveValid, isPawnMoveValid, isQueenMoveValid, isRookMoveValid, isTileOccupiedByFriendlyPiece } from "./rules"
...
export const isValidMove = (move: Move, board: Piece[]): boolean => {
    ...
    switch (move.piece.type) {
        case PieceType.PAWN: return isPawnMoveValid(move, board);
        case PieceType.KNIGHT: return isKnightMoveValid(move, board);
        case PieceType.BISHOP: return isBishopMoveValid(move, board);
        case PieceType.ROOK: return isRookMoveValid(move, board);
        case PieceType.QUEEN: return isQueenMoveValid(move, board)
        case PieceType.KING: return isKingMoveValid(move, board);
    }
}
